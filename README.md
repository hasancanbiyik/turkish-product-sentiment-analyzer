...
All dependencies are listed in `requirements.txt`, which includes the following:
- Deep learning frameworks like PyTorch and Transformers,
- Data processing like Pandas and NumPY,
- NLP tools like sentencepie for tokenization,
